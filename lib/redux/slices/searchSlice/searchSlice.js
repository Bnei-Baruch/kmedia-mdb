...
const onSearchSuccess = (state, { payload }) => {
  state.wip              = false;
  state.error            = null;
...
const onSearchFailure = (draft, { error }) => {
  draft.wip   = false;
...
export const searchSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(fetchSearch.fulfilled, onSearchSuccess);
    builder.addCase(fetchSearch.rejected, onSearchFailure);
