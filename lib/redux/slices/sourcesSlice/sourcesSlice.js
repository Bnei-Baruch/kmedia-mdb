...
import { fetchSQData } from '@/lib/redux/slices/sourcesSlice/thunks';
...
export const sourcesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(fetchSQData.rejected, onReceiveSources);
    builder.addCase(HYDRATE, (state, action) => ({ ...state, ...action.payload.sources }));
  }
});
