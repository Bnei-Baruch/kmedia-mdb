...
import { fetchHome, fetchBanners } from '@/lib/redux/slices/homeSlice/thunks';
...
export const homeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(fetchHome.fulfilled, onDataSuccess);
    builder.addCase(fetchHome.rejected, onDataFailure);
