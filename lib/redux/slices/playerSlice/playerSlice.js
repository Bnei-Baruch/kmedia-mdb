...
export const playerSlice = createSlice({
  ...
  initialState,
  reducers: {
    playerLoaded: draft => void (draft.loaded = true),
    playerMetadataReady: draft => draft.metadataReady = true,
    playerRemove: onRemove,
    setFile: onSetFile,

    playerPlay: onPlay,
    playerPause: draft => draft.played = false,
    playerBuffer: draft => draft.loaded = false,
    playerRate: (draft, payload) => draft.rate = payload.playbackRate,
    playerResize: (draft, payload) => draft.width = payload.width,
    playerToggleMute: (draft, payload) => draft.isMuted = payload.mute,
    setKeyboardCoef: (draft, payload) => draft.keyboardCoef = payload,

    setOverMode: onSetMode,
    setFullScreen: (draft, payload) => draft.isFullScreen = payload,
    setLoaded: (draft, payload) => draft.loaded = payload,

    setShareStartEnd: (draft, payload) => draft.shareStartEnd = payload,
    setIsMuted: (draft, payload) => draft.isMuted = payload,
  },
...
const isReady          = ({ ready, loaded }) => ({ ready, loaded });
