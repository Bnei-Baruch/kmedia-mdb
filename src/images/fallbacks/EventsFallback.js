...
const SvgEventsFallback = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={480} height={270} fill="none" {...props}>
        <path fill="#e5e5e5" d="M0 0h480v270H0z" />
        <path fill="#fff" d="M-2676-82H552v380h-3228z" />
        <g fill="#767676">
            <path d="M0 0h480v270H0z" />
            <path stroke="#5b5b5b" strokeLinecap="square" strokeWidth={4} d="M200 110h80v60h-80z" />
            <path stroke="#5b5b5b" strokeLinecap="square" strokeWidth={4} d="M200 104h80v60h-80z" />
            <path stroke="#5b5b5b" strokeLinecap="square" strokeWidth={4} d="M210 96h6v16h-6zM264 96h6v16h-6z" />
        </g>
        <g fill="#767676">
