...
export const UNIT_PUBLICATIONS_TYPE       = [CT_ARTICLE/*, CT_PUBLICATION*/, CT_BLOG_POST, SCT_TWEET];
...
export const LANG_UI_LANGUAGES       = [LANG_HEBREW, LANG_ENGLISH, LANG_RUSSIAN, LANG_SPANISH, LANG_ARABIC, LANG_GERMAN, LANG_UKRAINIAN, LANG_ITALIAN, LANG_TURKISH, LANG_CZECH, LANG_BULGARIAN, LANG_PORTUGUESE];
