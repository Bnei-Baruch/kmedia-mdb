...
export const CT_RABASH_LESSON         = 'RABASH_LESSON';
...
export const UNIT_LESSONS_TYPE            = [CT_LESSON_PART, /* CT_CHILDREN_LESSON, */ CT_WOMEN_LESSON, CT_RABASH_LESSON, CT_VIRTUAL_LESSON, CT_FULL_LESSON, CT_LECTURE];
