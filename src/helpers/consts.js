...
export const LANGUAGES = {
  [LANG_HEBREW]: { value: LANG_HEBREW, flag: 'il', locale: 'he_IL', lang3: 'HEB', name: 'Hebrew' },
  [LANG_ENGLISH]: { value: LANG_ENGLISH, flag: 'us', locale: 'en_US', lang3: 'ENG', name: 'English' },
  [LANG_RUSSIAN]: { value: LANG_RUSSIAN, flag: 'ru', locale: 'ru_RU', lang3: 'RUS', name: 'Russian' },
  [LANG_SPANISH]: { value: LANG_SPANISH, flag: 'es', locale: 'es_ES', lang3: 'SPA', name: 'Spanish' },
  [LANG_ITALIAN]: { value: LANG_ITALIAN, flag: 'it', locale: 'it_IT', lang3: 'ITA', name: 'Italian' },
  [LANG_GERMAN]: { value: LANG_GERMAN, flag: 'de', locale: 'de_DE', lang3: 'GER', name: 'German' },
  [LANG_DUTCH]: { value: LANG_DUTCH, flag: 'nl', locale: 'nl_NL', lang3: 'DUT', name: 'Dutch' },
  [LANG_FRENCH]: { value: LANG_FRENCH, flag: 'fr', locale: 'fr_FR', lang3: 'FRE', name: 'French' },
  [LANG_PORTUGUESE]: { value: LANG_PORTUGUESE, flag: 'pt', locale: 'pt_PT', lang3: 'POR', name: 'Portuguese' },
  [LANG_TURKISH]: { value: LANG_TURKISH, flag: 'tr', locale: 'tr_TR', lang3: 'TRK', name: 'Turkish' },
  [LANG_POLISH]: { value: LANG_POLISH, flag: 'pl', locale: 'pl_PL', lang3: 'POL', name: 'Polish' },
  [LANG_ARABIC]: { value: LANG_ARABIC, flag: 'sa', locale: 'ar_AR', lang3: 'ARB', name: 'Arabic' },
  [LANG_HUNGARIAN]: { value: LANG_HUNGARIAN, flag: 'hu', locale: 'hu_HU', lang3: 'HUN', name: 'Hungarian' },
  [LANG_FINNISH]: { value: LANG_FINNISH, flag: 'fi', locale: 'fi_FI', lang3: 'FIN', name: 'Finnish' },
  [LANG_LITHUANIAN]: { value: LANG_LITHUANIAN, flag: 'lt', locale: 'lt_LT', lang3: 'LIT', name: 'Lithuanian' },
  [LANG_JAPANESE]: { value: LANG_JAPANESE, flag: 'jp', locale: 'ja_JP', lang3: 'JPN', name: 'Japanese' },
  [LANG_BULGARIAN]: { value: LANG_BULGARIAN, flag: 'bg', locale: 'bg_BG', lang3: 'BUL', name: 'Bulgarian' },
  [LANG_GEORGIAN]: { value: LANG_GEORGIAN, flag: 'ge', locale: 'ka_GE', lang3: 'GEO', name: 'Georgian' },
  // TODO: choose from Norwegian Bokmål / Norwegian Nynorsk
  [LANG_NORWEGIAN]: { value: LANG_NORWEGIAN, flag: 'no', locale: 'nb_NO', lang3: 'NOT', name: 'Norwegian' },
  [LANG_SWEDISH]: { value: LANG_SWEDISH, flag: 'se', locale: 'sv_SE', lang3: 'SWE', name: 'Swedish' },
  [LANG_CROATIAN]: { value: LANG_CROATIAN, flag: 'hr', locale: 'hr_HR', lang3: 'HRV', name: 'Croatian' },
  [LANG_CHINESE]: { value: LANG_CHINESE, flag: 'cn', locale: 'zh_CN', lang3: 'CHN', name: 'Chinese' },
  [LANG_PERSIAN]: { value: LANG_PERSIAN, flag: 'ir', locale: 'fa_IR', lang3: 'PER', name: 'Persian' },
  [LANG_ROMANIAN]: { value: LANG_ROMANIAN, flag: 'ro', locale: 'ro_RO', lang3: 'RON', name: 'Romanian' },
  [LANG_HINDI]: { value: LANG_HINDI, flag: 'in', locale: 'hi_IN', lang3: 'HIN', name: 'Hindi' },
  [LANG_UKRAINIAN]: { value: LANG_UKRAINIAN, flag: 'ua', locale: 'uk_UA', lang3: 'UKR', name: 'Ukrainian' },
  [LANG_MACEDONIAN]: { value: LANG_MACEDONIAN, flag: 'mk', locale: 'mk_MK', lang3: 'MKD', name: 'Macedonian' },
  [LANG_SLOVENIAN]: { value: LANG_SLOVENIAN, flag: 'si', locale: 'sl_SI', lang3: 'SLV', name: 'Slovenian' },
  [LANG_LATVIAN]: { value: LANG_LATVIAN, flag: 'lv', locale: 'lv_LV', lang3: 'LAV', name: 'Latvian' },
  [LANG_SLOVAK]: { value: LANG_SLOVAK, flag: 'sk', locale: 'sk_SK', lang3: 'SLK', name: 'Slovak' },
  [LANG_CZECH]: { value: LANG_CZECH, flag: 'cz', locale: 'cs_CZ', lang3: 'CZE', name: 'Czech' },
  [LANG_AMHARIC]: { value: LANG_AMHARIC, flag: 'et', locale: 'am_ET', lang3: 'AMH', name: 'Amharic' },
};
