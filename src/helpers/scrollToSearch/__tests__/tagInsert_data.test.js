...
export const expected_withP = `<div><div class="scroll-to-search" id="__scrollSearchToHere__"><p> <strong><em class="_h">Body</em> <em class="_h">and</em> <em class="_h">Soul</em>   <em class="_h">Before</em> <em class="_h">I</em> <em class="_h">clarify</em> <em class="_h">this</em> <em class="_h">exalted</em> <em class="_h">matter,</em> <em class="_h">it</em> <em class="_h">is</em> <em class="_h">important</em> <em class="_h">for</em> <em class="_h">me</em> <em class="_h">to</em> <em class="_h">note</em> <em class="_h">that</em> <em class="_h">although</em> <em class="_h">all</em> <em class="_h">the</em> <em class="_h">readers</em> <em class="_h">seem</em> <em class="_h">to</em> <em class="_h">consider</em> it impossible to clarify and bring such a matter closer to the human mind, except by relying on abstract, philosophical concepts, as is usually the case with such scrutinies, since the day I have discovered the wisdom of Kabbalah and dedicated myself to it, I have distanced myself from abstract philosophy and all its branches as the east from the west. Everything that I will write henceforth will be from a purely scientific perspective, in utter precision, and by means of simple recognition of practical, useful things.</strong> </p></div> <p> <strong>Clearly, such a proof cannot be found in any spiritual matter, but only in physical matters, set up for perception by the senses. Hence, we are permitted to use the third method, to an extent. It engages only in matters of the body, in all those deductions that have been proven by experiments, and which no one doubts. The rest of the concepts, which combine the reason of their method and other methods, are fo…</strong></p></div>`;

export const expected_highlightBorder = '<div><div class="scroll-to-search" id="__scrollSearchToHere__"><p> <strong><em class="_h">Body</em> <em class="_h">and</em> <em class="_h">Soul</em> </p> <p> <strong>Before I clarify this exalted matter, it is important for me to note that although all the <em class="_h">readers</em> <em class="_h">seem</em> <em class="_h">to</em> <em class="_h">consider</em> it impossible to clarify and bring such a matter closer to the human mind, except by relying on abstract, philosophical concepts, as is usually the case with such scrutinies, since the day I have discovered the wisdom of Kabbalah and dedicated myself to it, I have distanced myself from abstract philosophy and all its branches as the east from the west. Everything that I will write henceforth will be from a purely scientific perspective, in utter precision, and by means of simple recognition of practical, useful things.</strong> </p></div> <p> <strong>Clearly, such a proof cannot be found in any spiritual matter, but only in physical matters, set up for perception by the senses. Hence, we are permitted to use the third method, to an extent. It engages only in matters of the body, in all those deductions that have been proven by experiments, and which no one doubts. The rest of the concepts, which combine the reason of their method and other methods, are fo…</strong></p></div>';
