...
class ShareFormDekstop extends Component {
  static propTypes = {
  ...
  setStart = (e, data) => {    
    ...
    // onSliceStartChange(start);
    // onSliceEndChange(end);
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Input value={url} class="ui row" size="mini" style={{ textAlign: 'left' , width: '100%' , margin: '0 0 1em 0' }} />
        <Form size="mini">
...
export default translate()(ShareFormDekstop);
