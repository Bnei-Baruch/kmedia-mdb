...
const serverErrorSplash                 = (err, t) =>
  <ErrorSplash text={t('messages.server-error')} subtext={formatError(err)} />;
export const wipLoadingSplash           = t =>
  <LoadingSplash text={t('messages.loading')} subtext={t('messages.loading-subtext')} />;
export const frownSplashContentNotFound = t => <FrownSplash text={t('messages.source-content-not-found')} />;
export const frownSplashNotFound        = t =>
  <FrownSplash text={t('messages.not-found')} subtext={t('messages.not-found-subtext')} />;
