  ...
  const renderAsCard = () => (
    <Card as={Link} to={href} raised>
      <div className="my_playlist_item">
        ...
        <UnitLogo unitId={item.content_unit_uid} width={520} fallbackImg={canonicalSection} />
      </div>
      <Card.Content>
      ...
      <Table.Cell width={7} className={'no-padding-top'}>
        <Link to={href}>
          <div className="my_playlist_item">
            ...
            <UnitLogo unitId={item.content_unit_uid} width={150} fallbackImg={canonicalSection} />
          </div>
        </Link>
      </Table.Cell>
