      ...
      return (
        <Segment>
          ...
          <ul>
            ...
            <li>Обратная связь – мы добавили опцию обратной связи, чтобы услышать ваши предложения; можно увидеть розовую иконку, нажать на нее и написать нам о том, что вас беспокоит, что не
              работает, и что нужно
              исправлять.
            </li>
      ...
      return (
        <Segment>
          ...
          <ul>
            ...
            <li>feedback - we have added a feedback option to hear from you what you need, look for the pink icon click and write to us what bothers you, what does not work and what needs to be
              fixed.
            </li>
