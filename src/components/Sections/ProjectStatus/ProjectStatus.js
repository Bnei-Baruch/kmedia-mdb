      ...
      return (
        <Segment>
          ...
          <ul>
            ...
            <li>Поисковая оптимизация (SEO) – оптимизация ресурса под требования поисковой системы Google.</li>
            <li>Обратная связь – мы добавили опцию обратной связи, чтобы услышать ваши предложения; можно увидеть розовую иконку, нажать на нее и написать нам о том, что вас беспокоит, что не работает, и что нужно исправлять.</li>
            <li>Баги – систематическая работа над багами и ошибками, чтобы все работала для вас должным образом.</li>
            <li>Организация и совершенствование материала – непрерывная работа по организации материала; есть довольно много того, что нужно описать, обозначить и проставить тэги, перевести.</li>
          ...
          <ul>
            ...
            <li>Вторая версия библиотеки – добавлены новые инструменты, необходимые для легкого чтения текста, совместимость с мобильным устройством, добавление текстов на английском и других дополнительных языках, исправление ошибок.</li>
            <li>Улучшением раздела лекций и уроков – работа над его улучшением, для того, чтобы было удобнее находить уроки и лекции.</li>
            <li>Серии уроков – дополнительный подраздел, в который будет включен ряд уроков, выстроенных по порядку и по источникам.</li>
            <li>Улучшенные качества фильтров – все фильтры на сайте будут совместимы с мобильными устройствами.</li>
