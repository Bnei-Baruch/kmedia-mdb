      ...
      return (
        <Segment>
          ...
          <ul>
            ...
            <li>Обратная связь – мы добавили опцию обратной связи, чтобы услышать ваши предложения; можно увидеть розовую иконку, нажать на нее и написать нам о том, что вас беспокоит, что не работает, и что нужно
            исправлять.
            </li>
          ...
          <ul>
            ...
            <li>Вторая версия библиотеки – добавлены новые инструменты, необходимые для легкого чтения текста, совместимость с мобильным устройством, добавление текстов на английском и других дополнительных языках,
            исправление ошибок.
            </li>
