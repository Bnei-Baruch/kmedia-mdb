...
import { DEFAULT_CONTENT_LANGUAGE, PAGE_NS_ARTICLES, PAGE_NS_AUDIO_BLOG } from '../../src/helpers/consts';
...
import Filters from '../../src/components/Sections/Publications/AudioBlog/Filters';
import SectionFiltersWithMobile from '../../src/components/shared/SectionFiltersWithMobile';
import AudioBlogFeed from '../../src/components/Sections/Publications/AudioBlog/AudioBlogFeed';
...
const AudioBlogPage             = ({ pageSize, total, items }) => {
  const filterComponent = <Filters namespace={PAGE_NS_AUDIO_BLOG} />;
  return (
    <PublicationsLayout namespace={PAGE_NS_AUDIO_BLOG}>
      <SectionFiltersWithMobile filters={filterComponent} namespace={PAGE_NS_AUDIO_BLOG}>
        <div>
          <Container className="padded">
            ...
            <Table unstackable basic="very" className="index" sortable>
              <Table.Body>
                {
                  items.map(x => (<AudioBlogFeed id={x.id} />))
                }
              </Table.Body>
            </Table>
          </Container>
