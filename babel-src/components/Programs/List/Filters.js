...
var filters = [{
  ...
  component: _filterComponents2.default.ProgramsFilter
}, {
  name: 'topics-filter',
...
var ProgramsFilters = function (_PureComponent) {
  _inherits(ProgramsFilters, _PureComponent);

  function ProgramsFilters() {
    _classCallCheck(this, ProgramsFilters);

    return _possibleConstructorReturn(this, (ProgramsFilters.__proto__ || Object.getPrototypeOf(ProgramsFilters)).apply(this, arguments));
  }

  _createClass(ProgramsFilters, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_FiltersHydrator2.default, { namespace: 'programs', onHydrated: onHydrated }),
        _react2.default.createElement(_Filters2.default, {
          namespace: 'programs',
          filters: filters,
          onFilterApplication: onChange
        }),
        _react2.default.createElement(_FilterTags2.default, { namespace: 'programs', onClose: onChange })
      );
    }
  }]);
...
ProgramsFilters.propTypes = {
  onChange: _propTypes2.default.func.isRequired,
  onHydrated: _propTypes2.default.func.isRequired
};
exports.default = ProgramsFilters;