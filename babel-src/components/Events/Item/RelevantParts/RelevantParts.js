...
var RelevantParts = function RelevantParts(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_semanticUiReact.Header, { as: 'h3', content: t('events.part.relevant-parts.title') }),
    _react2.default.createElement(
      ...
      otherParts.map(function (part) {
        return _react2.default.createElement(
          ...
          { as: _MultiLanguageLink2.default, key: part.id, to: '/events/item/' + part.id },
          _react2.default.createElement(
