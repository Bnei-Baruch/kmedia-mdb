    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_RMPVideoBox2.default, { unit: item, language: language, t: t, isSliceable: true })
        )
      )
    ),
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { width: 10 },
            _react2.default.createElement(_Info2.default, { unit: item, t: t }),
            _react2.default.createElement(_Materials2.default, { unit: item, t: t })
          ),
          _react2.default.createElement(
            _semanticUiReact.Grid.Column,
            { width: 6 },
            _react2.default.createElement(_MediaDownloads2.default, { unit: item, language: language, t: t }),
            _react2.default.createElement(_RelevantPartsContainer2.default, { unit: item, t: t })
          )
        )
      )
    )
...
exports.default = (0, _reactI18next.translate)()(EventItem);